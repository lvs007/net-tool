 ...
 */
package org.tron.net.common.overlay.discover;
...
import org.tron.net.common.overlay.server.WireTrafficStats;
import org.tron.net.services.NodeDetection;
import org.tron.net.common.net.udp.handler.MessageHandler;
import org.tron.net.common.net.udp.handler.PacketDecoder;
...
public class DiscoverServer {
    ...
    @Autowired
    public DiscoverServer(final NodeDetection nodeDetection) {
    ...
    public void start() throws Exception {
        ...
        try {
/*            discoveryExecutor = new DiscoveryExecutor(nodeDetection);
                ...
                b.group(group)
                        ...
                        .handler(new ChannelInitializer<NioDatagramChannel>() {
                            ...
                            public void initChannel(NioDatagramChannel ch)
                                ...
                                MessageHandler messageHandler = new MessageHandler(ch, nodeDetection);
                                nodeDetection.setMessageSender(messageHandler);
